...
const Main = (props) => {
  const {promotionTitle, promotionGenre, promotionReleaseDate, films, onFilmTitleOrImgClick} = props;

  return <React.Fragment>
    <section className="movie-card">
      <div className="movie-card__bg">
        <img src="img/bg-the-grand-budapest-hotel.jpg" alt={promotionTitle} />
      </div>
      ...
      <div className="movie-card__wrap">
        <div className="movie-card__info">
          <div className="movie-card__poster">
            <img src="img/the-grand-budapest-hotel-poster.jpg" alt={`${promotionTitle} poster`} width="218" height="327" />
          </div>
